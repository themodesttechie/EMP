...
function ManageAbsenceTimeMachine() {
    ...
    const [viewYear, setViewYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(currentYear);
    const [viewMonth, setViewMonth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date().getMonth()); // 0-11
    ...
    const calendarGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManageAbsenceTimeMachine.useMemo[calendarGrid]": ()=>{
    ...
    const filteredList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManageAbsenceTimeMachine.useMemo[filteredList]": ()=>{
            return requests.filter({
                "ManageAbsenceTimeMachine.useMemo[filteredList]": (r)=>{
    ...
    const selectedReq = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManageAbsenceTimeMachine.useMemo[selectedReq]": ()=>requests.find({
                "ManageAbsenceTimeMachine.useMemo[selectedReq]": (r)=>r.id === selectedId
            }["ManageAbsenceTimeMachine.useMemo[selectedReq]"]) || requests[0]
    }["ManageAbsenceTimeMachine.useMemo[selectedReq]"], [
        requests,
        selectedId
    ]);
    // --- HELPERS ---
...
_s(ManageAbsenceTimeMachine, "UnJxkUDTDQJAjmN3PJ966Sk7GPQ=");
_c = ManageAbsenceTimeMachine;
var _c;
__turbopack_context__.k.register(_c, "ManageAbsenceTimeMachine");
...
//# sourceMappingURL=_e842c4eb._.js.map