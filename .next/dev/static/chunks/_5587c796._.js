...
function ZeroScrollPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ZeroScrollPortal.useEffect": ()=>{
            ...
            return ({
                "ZeroScrollPortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["ZeroScrollPortal.useEffect"];
        }
    }["ZeroScrollPortal.useEffect"], []);
    // --- LOGIC ---
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ZeroScrollPortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "ZeroScrollPortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = HOLIDAYS.some({
                        "ZeroScrollPortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["ZeroScrollPortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["ZeroScrollPortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "ZeroScrollPortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["ZeroScrollPortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = LEAVE_TYPES.find({
                "ZeroScrollPortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["ZeroScrollPortal.useMemo[stats].selectedType"]);
...
_s(ZeroScrollPortal, "Dj8N2CefRNG8NX3rCZr8Lc6trsk=");
_c = ZeroScrollPortal;
var _c;
__turbopack_context__.k.register(_c, "ZeroScrollPortal");
...
//# sourceMappingURL=_5587c796._.js.map