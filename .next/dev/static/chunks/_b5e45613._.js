...
function NaturalFitPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NaturalFitPortal.useEffect": ()=>{
            ...
            return ({
                "NaturalFitPortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["NaturalFitPortal.useEffect"];
        }
    }["NaturalFitPortal.useEffect"], []);
    // --- LOGIC ---
    const calendarData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NaturalFitPortal.useMemo[calendarData]": ()=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NaturalFitPortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "NaturalFitPortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = COMPANY_CONFIG.holidays.some({
                        "NaturalFitPortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["NaturalFitPortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["NaturalFitPortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "NaturalFitPortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["NaturalFitPortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = COMPANY_CONFIG.leaveTypes.find({
                "NaturalFitPortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["NaturalFitPortal.useMemo[stats].selectedType"]);
            const today = new Date();
...
_s(NaturalFitPortal, "jWCzk/4U0MeiTwlnUnWE1hqZ1u8=");
_c = NaturalFitPortal;
var _c;
__turbopack_context__.k.register(_c, "NaturalFitPortal");
...
//# sourceMappingURL=_b5e45613._.js.map