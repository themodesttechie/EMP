...
function RobustTimesheet() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RobustTimesheet.useEffect": ()=>{
            if (toast) {
                const timer = setTimeout({
                    "RobustTimesheet.useEffect.timer": ()=>setToast(null)
                }["RobustTimesheet.useEffect.timer"], 3000);
                return ({
                    "RobustTimesheet.useEffect": ()=>clearTimeout(timer)
                })["RobustTimesheet.useEffect"];
            }
        }
    }["RobustTimesheet.useEffect"], [
    ...
    /* --- DERIVED: DAYS --- */ const days = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RobustTimesheet.useMemo[days]": ()=>{
            return Array.from({
                length: 7
            }).map({
                "RobustTimesheet.useMemo[days]": (_, i)=>{
    ...
    /* --- DERIVED: STATS & PROJECT SUMMARY --- */ const { stats, projectSummary } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RobustTimesheet.useMemo": ()=>{
            let totalMins = 0;
            let billableMins = 0;
            const summary = {};
            Object.values(currentData.entries).forEach({
                "RobustTimesheet.useMemo": (dayEntries)=>{
                    dayEntries.forEach({
                        "RobustTimesheet.useMemo": (e)=>{
                            const mins = e.hours * 60 + e.minutes;
                            totalMins += mins;
                            if (PROJECTS.find({
                                "RobustTimesheet.useMemo": (p)=>p.id === e.projectId
                            }["RobustTimesheet.useMemo"])?.billable) billableMins += mins;
                            // Project Summary
            ...
            return {
                stats: {
                    ...
                    utilization: Math.min(100, totalMins / 2400 * 100) // Based on 40h (2400m)
                },
    ...
    /* --- ACTIONS --- */ const updateDb = (fn)=>{
        setDb((prev)=>fn(prev));
        if (!isLocked) setHasUnsavedChanges(true);
    };
    const handleNavigate = (dir)=>{
        if (hasUnsavedChanges && !confirm("You have unsaved changes. Navigate anyway?")) return;
        setCurrentWeekStart((prev)=>addDays(prev, dir === 'next' ? 7 : -7));
        setHasUnsavedChanges(false);
    };
    /* --- FEATURE: SAVE DRAFT --- */ const handleSaveDraft = ()=>{
        setIsSaving(true);
    ...
    /* --- FEATURE: SMART ACTIONS --- */ const handleSmartFill = ()=>{
        if (isLocked) return;
        const newEntries = {
            ...currentData.entries
        };
    ...
    const handleCopyDayToNext = (dateStr)=>{
        ...
        // Don't overwrite if blocked or outside current week view (simple logic for now)
        if (HOLIDAYS.includes(nextDayStr) || APPROVED_LEAVES.includes(nextDayStr)) {
            setToast({
                type: 'error',
                msg: "Cannot copy to a blocked day"
            });
            return;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    PROJECTS.map((p)=>{
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex-shrink-0 bg-slate-50 dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-800 min-w-[140px]",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-7xl mx-auto px-6 mb-6 flex justify-end gap-3",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-7 gap-4",
                children: days.map((d)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `
                                relative min-h-[240px] rounded-2xl border transition-all duration-300 flex flex-col group
                                ${d.isBlocked ? "bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800 cursor-not-allowed" : "bg-white dark:bg-[#11151F] border-slate-200 dark:border-slate-800 hover:border-blue-400 hover:shadow-lg"}
                            `,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "p-3 border-b border-slate-100 dark:border-slate-800/50 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/30 rounded-t-2xl",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    !d.isBlocked && totalMins > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-[10px] font-black px-2 py-0.5 rounded bg-slate-100 text-slate-600",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: `flex-1 p-2 space-y-2 overflow-y-auto max-h-[300px] custom-scrollbar ${!d.isBlocked && !isLocked ? 'cursor-pointer' : ''}`,
                                children: [
                                    d.entries.map((e)=>{
                            ...
                            !isLocked && !d.isBlocked && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "p-2 border-t border-slate-100 dark:border-slate-800 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: (e)=>{
                                            e.stopPropagation();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-0 w-full bg-white dark:bg-[#11151F] border-t border-slate-200 dark:border-slate-800 p-4 z-40 flex justify-center items-center gap-4",
                children: isLocked ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            disabled: isSaving,
                            className: `px-8 py-3 rounded-full font-bold text-sm border flex items-center gap-2 transition-all ${hasUnsavedChanges ? 'border-amber-400 text-amber-600 bg-amber-50 animate-pulse' : 'border-slate-200 text-slate-600 hover:bg-slate-50'}`,
                            children: [
...
_s(RobustTimesheet, "Hzhp5UPT6yTz/4SjpAQ5P70SEKM=");
_c = RobustTimesheet;
var _c;
__turbopack_context__.k.register(_c, "RobustTimesheet");
...
//# sourceMappingURL=_a1b80d1e._.js.map