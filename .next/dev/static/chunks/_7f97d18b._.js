...
function HeaderFlowPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HeaderFlowPortal.useEffect": ()=>{
            ...
            return ({
                "HeaderFlowPortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["HeaderFlowPortal.useEffect"];
        }
    }["HeaderFlowPortal.useEffect"], []);
    // --- LOGIC: CALENDAR ---
    const calendarData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HeaderFlowPortal.useMemo[calendarData]": ()=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HeaderFlowPortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "HeaderFlowPortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = COMPANY_CONFIG.holidays.some({
                        "HeaderFlowPortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["HeaderFlowPortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["HeaderFlowPortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "HeaderFlowPortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["HeaderFlowPortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = COMPANY_CONFIG.leaveTypes.find({
                "HeaderFlowPortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["HeaderFlowPortal.useMemo[stats].selectedType"]);
            const today = new Date();
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-3 bg-slate-50 dark:bg-white/5 px-4 py-1.5 rounded-full border border-slate-100 dark:border-white/5",
                        children: [
                            ...
                            COMPANY_CONFIG.approvers.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center gap-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "h-6 w-6 rounded-full bg-white dark:bg-[#222] border border-slate-200 dark:border-white/10 flex items-center justify-center text-[9px] font-bold text-slate-700 dark:text-slate-300 shadow-sm",
                                                    title: p.name,
                                                    children: p.avatar
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(admin)/(others-pages)/request-absence/page.tsx",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-xs font-semibold text-slate-700 dark:text-slate-300 hidden sm:block",
                                                    children: p.role
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(admin)/(others-pages)/request-absence/page.tsx",
                                                    lineNumber: 226,
...
_s(HeaderFlowPortal, "jWCzk/4U0MeiTwlnUnWE1hqZ1u8=");
_c = HeaderFlowPortal;
var _c;
__turbopack_context__.k.register(_c, "HeaderFlowPortal");
...
//# sourceMappingURL=_7f97d18b._.js.map