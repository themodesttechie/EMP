...
function PremiumAbsencePortal() {
    ...
    const [coverId, setCoverId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PremiumAbsencePortal.useEffect": ()=>{
            ...
            return ({
                "PremiumAbsencePortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["PremiumAbsencePortal.useEffect"];
        }
    }["PremiumAbsencePortal.useEffect"], []);
    // --- LOGIC ---
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PremiumAbsencePortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "PremiumAbsencePortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = HOLIDAYS.some({
                        "PremiumAbsencePortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["PremiumAbsencePortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["PremiumAbsencePortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "PremiumAbsencePortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["PremiumAbsencePortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = LEAVE_TYPES.find({
                "PremiumAbsencePortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["PremiumAbsencePortal.useMemo[stats].selectedType"]);
                                ...
                                children: [
                                    ...
                                    APPROVER_CHAIN.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, {
                                            children: [
                                                ...
                                                i < APPROVER_CHAIN.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(PremiumAbsencePortal, "Dj8N2CefRNG8NX3rCZr8Lc6trsk=");
_c = PremiumAbsencePortal;
var _c;
__turbopack_context__.k.register(_c, "PremiumAbsencePortal");
...
//# sourceMappingURL=_40cb3cf0._.js.map