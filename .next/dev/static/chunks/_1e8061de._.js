...
function ManageAbsenceClean() {
    ...
    const filteredList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManageAbsenceClean.useMemo[filteredList]": ()=>{
            if (filter === "All") return requests;
            return requests.filter({
                "ManageAbsenceClean.useMemo[filteredList]": (r)=>r.status === filter
            }["ManageAbsenceClean.useMemo[filteredList]"]);
        }
    }["ManageAbsenceClean.useMemo[filteredList]"], [
        requests,
    ...
    const selectedReq = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManageAbsenceClean.useMemo[selectedReq]": ()=>requests.find({
                "ManageAbsenceClean.useMemo[selectedReq]": (r)=>r.id === selectedId
            }["ManageAbsenceClean.useMemo[selectedReq]"]) || requests[0]
    }["ManageAbsenceClean.useMemo[selectedReq]"], [
        requests,
        selectedId
    ]);
    // --- ACTIONS ---
                                ...
                                children: filteredList.map((req)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            req.status === 'Pending' && !isSelected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ManageAbsenceClean, "pFI96QA77TZ6jCGZffu4IGxXF7I=");
_c = ManageAbsenceClean;
var _c;
__turbopack_context__.k.register(_c, "ManageAbsenceClean");
...
//# sourceMappingURL=_1e8061de._.js.map