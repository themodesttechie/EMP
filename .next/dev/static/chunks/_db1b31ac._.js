...
function AdminReadyPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminReadyPortal.useEffect": ()=>{
            ...
            return ({
                "AdminReadyPortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["AdminReadyPortal.useEffect"];
        }
    }["AdminReadyPortal.useEffect"], []);
    // --- LOGIC ---
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminReadyPortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "AdminReadyPortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = COMPANY_CONFIG.holidays.some({
                        "AdminReadyPortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["AdminReadyPortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["AdminReadyPortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "AdminReadyPortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["AdminReadyPortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = COMPANY_CONFIG.leaveTypes.find({
                "AdminReadyPortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["AdminReadyPortal.useMemo[stats].selectedType"]);
                                        ...
                                        Array.from({
                                            ...
                                            if (existing) {
                                                if (existing.status === 'approved') {
                                                    ...
                                                    label = !isSelected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "flex items-center gap-1",
                                                        children: [
...
_s(AdminReadyPortal, "Dj8N2CefRNG8NX3rCZr8Lc6trsk=");
_c = AdminReadyPortal;
var _c;
__turbopack_context__.k.register(_c, "AdminReadyPortal");
...
//# sourceMappingURL=_db1b31ac._.js.map