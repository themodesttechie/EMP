...
function PerfectFitPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PerfectFitPortal.useEffect": ()=>{
            ...
            return ({
                "PerfectFitPortal.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["PerfectFitPortal.useEffect"];
        }
    }["PerfectFitPortal.useEffect"], []);
    // --- LOGIC ---
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PerfectFitPortal.useMemo[stats]": ()=>{
            let days = 0, deduction = 0, sandwichWarning = false, projection = 0;
            const checkDay = {
                "PerfectFitPortal.useMemo[stats].checkDay": (dStr)=>{
                    const dObj = new Date(dStr);
                    const isHoliday = COMPANY_CONFIG.holidays.some({
                        "PerfectFitPortal.useMemo[stats].checkDay.isHoliday": (h)=>h.date === dStr
                    }["PerfectFitPortal.useMemo[stats].checkDay.isHoliday"]);
                    const isWeekend = dObj.getDay() === 0 || dObj.getDay() === 6;
                    if (!isHoliday && !isWeekend) return 1;
                    return 0;
                }
            }["PerfectFitPortal.useMemo[stats].checkDay"];
            if (mode === "multi") {
                days = multiDates.length;
                deduction = multiDates.reduce({
                    "PerfectFitPortal.useMemo[stats]": (acc, date)=>acc + checkDay(date)
                }["PerfectFitPortal.useMemo[stats]"], 0);
            } else {
            ...
            const selectedType = COMPANY_CONFIG.leaveTypes.find({
                "PerfectFitPortal.useMemo[stats].selectedType": (t)=>t.id === typeId
            }["PerfectFitPortal.useMemo[stats].selectedType"]);
...
_s(PerfectFitPortal, "Dj8N2CefRNG8NX3rCZr8Lc6trsk=");
_c = PerfectFitPortal;
var _c;
__turbopack_context__.k.register(_c, "PerfectFitPortal");
...
//# sourceMappingURL=_0191e862._.js.map